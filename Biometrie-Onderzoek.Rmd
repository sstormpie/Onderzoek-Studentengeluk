...
Hierboven worden 3 verschillende tests gedaan: Een Shapiro test, een T-test, en een Welch Two Sample T-test. In deze tests worden meerdere dingen berekend. Wij moeten kijken naar de p-value, als die niet 0 is, is er een verschil en kunnen wij de hypothese aannemen. En zoals te zien is in de tests hierboven is de p-value niet 0, dus kunnen wij de hypothese aannemen. De mannelijke hand is dus gemiddeld groter dan de vrouwlijke hand.
...
Er is een klein verschil tussen de twee meters. Dit zou kunnen doordat ze de startplaats van de pols anders hebben geïnterpreteerd. 
...
Om nog een duidelijker protocol te maken zou er een voorbeeld foto kunnen worden toegevoegd ( of video ) van de meetwijze zodat deze exact kan worden gerepliceerd.
:::
