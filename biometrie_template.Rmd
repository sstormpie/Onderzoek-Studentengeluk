...
Hierboven worden 3 verschillende tests gedaan: Een Shapiro test, een T-test, en een Welch Two Sample T-test. In deze tests worden meerdere dingen berekend. Wij moeten kijken naar de p-value, als die niet 0 is, is er een verschil en kunnen wij de hypothese aannemen. En zoals te zien is in de tests hierboven is de p-value niet 0, dus kunnen wij de hypothese aannemen.
