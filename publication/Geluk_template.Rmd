...
```{r, fig.asp=.75, out.width='50%', fig.align='center', fig.cap="Antwoord per Niveau", echo=FALSE}
...
```{r, fig.asp=.75, out.width='50%', fig.align='center',fig.cap="vergelijking geluk en gebruik drugs en alcohol", echo=FALSE}
...
```{r, fig.asp=.75, out.width='50%', fig.align='center', fig.cap="Gemiddeld geluk jong volwassenen",echo=FALSE}
