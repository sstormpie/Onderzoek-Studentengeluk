...
```{r hist algemeen geluk, plot-with-untidy-data, fig.asp=.75, out.width='50%', fig.align='center', fig.cap='Selecting untidy data', echo=FALSE}
...
```{r, echo=FALSE}
hbo_student <- subset(Student_awn_data, Niveau == "HBO")
masters_student <- subset(Student_awn_data, Niveau == "Masters")
mbo_student <- subset(Student_awn_data, Niveau == "MBO")
uni_student <- subset(Student_awn_data, Niveau == "Universiteit (University) Bachelor")
```
