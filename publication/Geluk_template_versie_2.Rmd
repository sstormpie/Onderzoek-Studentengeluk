...
```{r , fig.asp=.75, out.width='50%', fig.align='center',  echo=FALSE}
...
```{r plot-with-untidy-data, fig.asp=.75, out.width='50%', fig.align='center',  echo=FALSE}
...
knitr::kable(df_gem_geluk_sexe, align = "c", caption = "Gemiddelde geluk vrouw & man") 


```

Hier gemiddeld duidelijker het gemiddelde te zien van de man en vrouw. De man heeft een gemiddeld geluk van ongeveer 6.45 / 10 de vrouw heeft een gemiddeld geluk van 6.25 wat dus inderdaad betekent dat mannelijke studenten in Groningen over het algemeen gemiddeld het gelukkigste zijn van de sekse.
...
ggplot(gem_geluk_laatste_data, aes(x = Woonsituatie, y = average_col, fill = Woonsituatie)) + 
    ...
    ylim(0, 10) +
    geom_boxplot() +
  labs(caption = "Figuur 5 : gem geluk per woonsituatie") +
...
ggplot(Drugs_gebruik_Sekse, aes(x=Sekse, y=Verd_mid_gebr, fill = Sekse)) +
  ...
  ylab("Drugs gebruik") + 
  labs(caption = "Figuur 6: Drugs en of alcohol gebruik per sekse") +
...
ggplot(Drugs_gebruik_Sekse, aes(x=drugs_alc_geluk, y=Verd_mid_gebr)) +
  ...
  xlab("Geluk's gevoel door gebruik Drugs en of alcohol") + 
    labs(caption = "Figuur 7: vergelijking geluk en gebruik drugs en alcohol") +
...
ggplot(Drugs_gebruik_woonsit, aes(x=Woonsituatie, y=Verd_mid_gebr, fill = Woonsituatie)) +
  geom_bar(stat = "identity") +
  ylab("Drugs gebruik") + 
    labs(caption = "Figuur 8: Drugs gebruik per woonsituatie") +
  theme(legend.position="none")
...
ggplot(Student_awn_data, aes(x = Opl_jaar, y = Mental_health, fill = Opl_jaar)) +
      stat_boxplot(geom = "errorbar",
               width = 0.25) +
    ylim(0, 10) +
  labs(caption = "Figuur 9: mentale gezondheid per opleidingsjaar") +
  geom_boxplot() +
...
ggplot(Student_awn_data, aes(x = Woonsituatie, y = Mental_health, fill = Woonsituatie)) +
      stat_boxplot(geom = "errorbar",
               width = 0.25) +
    ylim(0, 10) +
  labs(caption = "Figuur 10: mentale gezondheid per woonsituatie") +
  geom_boxplot() +
...
ggplot(Student_awn_data, aes(x = Vakgebied, y = Mental_health, fill = Vakgebied)) +
      stat_boxplot(geom = "errorbar",
               width = 0.25) +
    ylim(0, 10) +
  labs(caption = "Figuur 11: mentale gezondheid per vakgebied") +
  geom_boxplot() +
...
ggplot(laatste_data, aes(x = Sekse, y = Financiele_sit, fill = Sekse)) +
    stat_boxplot(geom = "errorbar",
               width = 0.25) +
    ylim(0, 10) +
  labs(caption = "Figuur 12: Financiele situatie per sekse") +
  geom_boxplot() +
